        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="dashboard-card bg-gradient-to-r from-blue-600/10 to-purple-600/10 border-blue-600/20">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                <h3 className="text-xl font-semibold mb-2">Want to broadcast your event on CAIWAVE TV?</h3>
                <p className="text-neutral-400">
                  Political campaigns, church services, community announcements - reach thousands of WiFi users.
                </p>
              </div>
              <a
                href="https://wa.me/254738570630"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition-colors whitespace-nowrap"
                data-testid="contact-caiwave-whatsapp"
              >
