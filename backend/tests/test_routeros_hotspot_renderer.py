...
def test_renders_hotspot_section():
    ...
    assert '/ip hotspot profile add comment="CAIWAVE managed hotspot profile" dns-name="wifi.caiwave.com" hotspot-address="10.10.0.1" login-by="http-pap" name="caiwave-profile" use-radius=yes' in section.content
